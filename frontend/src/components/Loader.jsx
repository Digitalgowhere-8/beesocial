...
export default function Loader({ label = 'Loading' }) {
  return (
    <div className="app-loader min-h-screen flex flex-col items-center justify-center gap-4" style={{ background: '#FAF0F2' }}>
      ...
      <span className="app-loader-label text-[11px] uppercase tracking-[0.18em] font-bold" style={{ color: '#D11243' }}>
        {label}
      </span>
